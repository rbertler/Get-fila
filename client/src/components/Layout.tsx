...
function InsightGeneratingBanner() {
  ...
  return (
    <div className="fixed bottom-20 md:bottom-5 left-1/2 -translate-x-1/2 z-50 w-80 rounded-xl border bg-white shadow-lg px-4 py-3 space-y-2">
      <p className="text-sm font-medium flex items-center gap-2" style={{ color: '#102a45' }}>
        <Brain className="h-4 w-4 shrink-0" style={{ color: '#244a73' }} />
      ...
      <div className="h-2 w-full rounded-full overflow-hidden bg-gray-100">
        <div
          ...
          style={{ background: 'linear-gradient(135deg, #adcce6 0%, #244a73 100%)' }}
        />
      </div>
    </div>
  );
...
export function Layout() {
  return (
    <div className="flex h-screen overflow-hidden bg-[#d6e6f5]">
      <Sidebar />
